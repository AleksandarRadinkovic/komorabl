...
interface IzvjestajiHeroProps {
  dict: any;
  lang: string;
}

export default function IzvjestajiHero({ dict, lang }: IzvjestajiHeroProps) {
  return (
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <span>/</span>
            <span className="text-accent font-semibold">{dict.breadcrumb.reports}</span>
          </motion.div>
