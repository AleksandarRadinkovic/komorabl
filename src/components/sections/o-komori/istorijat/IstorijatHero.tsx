...
interface IstorijatHeroProps {
  dict: any;
  lang: string;
}

export default function IstorijatHero({ dict, lang }: IstorijatHeroProps) {
  return (
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <span>/</span>
            <span className="text-accent font-semibold">{dict.breadcrumb.history}</span>
          </motion.div>
